...
the api consists of two major steps for (authenticating the merchant itself and the platform users & providers)
...
After completed the first step successfully you should obtain an API `token` which is mandatory the upcoming steps.
