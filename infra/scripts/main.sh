...
_mainScript_() {
  ...
  _executeScript_ "$(_findBaseDir_)/monitoring.sh"
  _executeScript_ "$(_findBaseDir_)/portainer.sh"
  _executeScript_ "$(_findBaseDir_)/databases.sh"
  _executeScript_ "$(_findBaseDir_)/IAM.sh"
  _executeScript_ "$(_findBaseDir_)/swarmprom.sh"
  _executeScript_ "$(_findBaseDir_)/ci.sh"
